...
const WA_URL = `https://wa.me/56983568212?text=${encodeURIComponent("Hola, quiero saber más sobre sus servicios")}`;
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center
        shadow-[0_4px_24px_rgba(37,211,102,0.4)] hover:scale-110 transition-all duration-300
