...
const LINKS = {
  ...
  "Recursos":  [{ l: "Intelligence Unit", h: "#blog" }, { l: "Diagnóstico Gratis", h: "#diagnostico" }, { l: "Contacto", h: "#contacto" }],
  "Contacto":  [
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr_1fr_1fr] gap-12 mb-14">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Redes sociales — agregar URLs reales cuando estén disponibles */}
